            ...
            Scaffold(topBar = {
                ...
                NavHost(
                    ...
                    composable(DialysisDestination.MainScreen.route) {
                        DialysisList(dialysisViewModel.dialysisList.observeAsState(initial = listOf()).value, innerPadding, onItemClicked = { itemId ->
                    ...
                    composable(DialysisDestination.PDFList.route) {
                        ...
                        PDFList(pdfViewModel.allPDFsGenerated.observeAsState(initial = listOf()).value, innerPadding)
                    }
